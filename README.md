...
详见[执行协议](docs/environment-contract.md)、[复现与图解工作流](docs/reproduction-workflow.md)、[收录流程](CONTRIBUTING.md)、[设计记录](docs/design-session.md)、[候选 CVE 选型](docs/cve-candidates.md)和[术语](CONTEXT.md)。
